            ...
            <ul class="nav" id="mainNav">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu">
                        <a href="../gate automation.php" class="dropdown-item">
                            <i class="fas fa-robot"></i>
                            Gate Automation
                        </a>
                        <a href="../gate_fabrication.php" class="dropdown-item">
                            <i class="fas fa-hammer"></i>
                            Gate Fabrication
                        </a>
                        <a href="../garage_door.php" class="dropdown-item">
                            <i class="fas fa-warehouse"></i>
                            Sectional Garage Door
                        </a>
                        <a href="../roll_up_door.php" class="dropdown-item">
                            <i class="fas fa-door-open"></i>
                            Roll Up Door
                        </a>
                        <a href="../electric_fence.php" class="dropdown-item">
                            <i class="fas fa-bolt"></i>
                            Smart Electric Fence
                        </a>
                        <a href="../smart_curtain.php" class="dropdown-item">
